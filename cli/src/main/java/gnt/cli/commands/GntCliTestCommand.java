/*
 * Copyright © 2018 cmri and others.  All rights reserved.
 *
 * This program and the accompanying materials are made available under the
 * terms of the Eclipse Public License v1.0 which accompanies this distribution,
 * and is available at http://www.eclipse.org/legal/epl-v10.html
 */
package gnt.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import gnt.cli.api.GntCliCommands;
...
public class GntCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(GntCliTestCommand.class);
    protected final GntCliCommands service;

    public GntCliTestCommand(final GntCliCommands service) {
